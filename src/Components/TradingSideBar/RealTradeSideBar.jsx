    ...
    <div className="">
      ...
      <div className="bg-slate-200 px-4 py-6 my-1">
        ...
        >
          ...
          <span onClick={onDeposit} className="text-base text-white font-regular">Buy In</span>
        ...
        <button
          ...
          aria-label="Buy Out"
        >
          <span onClick={onWithdraw} className="text-base text-white font-regular">Buy Out</span>
          <div className="flex items-center gap-16">
            <span className="text-2xl font-bold text-white">
              {stake || "10.00"}
            </span>
...
export default RealTradeSideBar;
